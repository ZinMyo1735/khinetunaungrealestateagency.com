...
<section class="intro-single">
    <div class="container">
        ...
        <div class="col-md-12 col-lg-12">
            ...
            <h1 class="title-single">{{ $condos->post_title }}</h1>
            <span class="color-text-a">{{ $condos->location_name }} Township</span>
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-sm-12">
            ...
            <div class="carousel-item-b">
                <img src="{{ asset('storage/'.$condos->image_2) }}" alt="">
            </div>
            <div class="carousel-item-b">
                <img src="{{ asset('storage/'.$condos->image_3) }}" alt="">
            </div>
            <div class="carousel-item-b">
                <img src="{{ asset('storage/'.$condos->image_4) }}" alt="">
            </div>
            </div>
            ...
            <div class="col-md-5 col-lg-4">
                ...
                <div class="card-header-c d-flex">
                    ...
                    <span class="ion-money">{{ $condos->price }}</span>
                    </div>
                ...
                <div class="summary-list">
                    ...
                    <li class="d-flex justify-content-between">
                        ...
                        <span>{{ $condos->location_name }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Property Type:</strong>
                        <span>{{ $condos->type }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Area:</strong>
                        <span>{{ $condos->dimension }} ft
                        <sup>2</sup>
                        </span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Master Bedroom:</strong>
                        <span>{{ $condos->master_bedroom }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Double Bedroom:</strong>
                        <span>{{ $condos->double_bedroom }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Single Bedroom:</strong>
                        <span>{{ $condos->single_bedroom }}</span>
                    </li>
                    </ul>
                </div>
                </div>
