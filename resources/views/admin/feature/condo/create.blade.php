...
@section('title','Feature Condo Create')
                ...
                <div class="col-lg-10">
                    <div class="au-card au-card--no-shadow au-card--no-pad">
                        <div class="au-card-title" style="background-image:url({{ asset('admin/images/bg.jpg') }});">
                            ...
                            <h3>
                                <a href="{{ route('condo#list') }}" class="text-white">
                                    <i class="fas fa-arrow-circle-left mr-5"></i>
                                </a>
                                Add New Featured Condo Post
                            </h3>
                        </div>
                        <div class="card-body card-block">
                            <form action="{{ route('condo#create') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                        <label class=" form-control-label">Image 1 (1:1)</label>
                                    </div>
                                    <div class="col-12 col-md-9">
