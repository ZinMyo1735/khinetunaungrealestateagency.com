...
@section('title','Feature Property List')
                    ...
                    <div class="table-data__tool">
                        <div class="table-data__tool-left">
                            <div class="overview-wrap">
                                <h2 class="title-1 text-secondary">Featured Property Posts</h2>
                            </div>
                        </div>
                        <div class="table-data__tool-right">
                            <div class="overview-wrap">
                                <a href="{{ route('fproperty#createPage') }}">
            ...
            <div class="table-responsive table-responsive-data2 text-center mt-2">
                ...
                <table class="table table-data2">
                    ...
                    <tbody>
                        ...
                        <tr class="tr-shadow">
                            ...
                            <td class="d-flex justify-content-center">
                                <div class="table-data-feature">
                                    <a href="{{ route('fproperty#edit',$house->id) }}" class="mr-2">
                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="zmdi zmdi-edit text-success"></i>
                                        </button>
                                    </a>
                                    <a href="{{ route('fproperty#delete',$house->id) }}">
                      ...
                      @endforeach
                    @else
                        <h3 class="text-secondary text-center ">There is no Feature Property Posts Here!</h3>
                    @endif  
                    </tbody>
                </table>
