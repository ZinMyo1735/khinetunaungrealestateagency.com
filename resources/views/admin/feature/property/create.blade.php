...
@section('title','Feature Property Create')
                    ...
                    <div class="au-card au-card--no-shadow au-card--no-pad">
                        <div class="au-card-title" style="background-image:url({{ asset('admin/images/bg.jpg') }});">
                            ...
                            <h3>
                                ...
                                Add New Featured Property Post
                            </h3>
                        </div>
                        <div class="card-body card-block">
                            <form action="{{ route('fproperty#create') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                @csrf
