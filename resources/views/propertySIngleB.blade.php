...
<section class="intro-single">
    <div class="container">
        ...
        <div class="col-md-12 col-lg-12">
            ...
            <h1 class="title-single">{{ $banners->post_title }}</h1>
            <span class="color-text-a">{{ $banners->location_name }} Township</span>
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-sm-12">
            ...
            <div class="carousel-item-b">
                <img src="{{ asset('storage/'.$banners->image_2) }}" alt="">
            </div>
            <div class="carousel-item-b">
                <img src="{{ asset('storage/'.$banners->image_3) }}" alt="">
            </div>
            <div class="carousel-item-b">
                <img src="{{ asset('storage/'.$banners->image_4) }}" alt="">
            </div>
            </div>
            ...
            <div class="col-md-5 col-lg-4">
                ...
                <div class="card-header-c d-flex">
                    ...
                    <span class="ion-money">{{ $banners->price }}</span>
                    </div>
                ...
                <div class="summary-list">
                    ...
                    <li class="d-flex justify-content-between">
                        ...
                        <span>{{ $banners->location_name }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Property Type:</strong>
                        <span>{{ $banners->type }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Area:</strong>
                        <span>{{ $banners->dimension }} ft
                        <sup>2</sup>
                        </span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Master Bedroom:</strong>
                        <span>{{ $banners->master_bedroom }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Double Bedroom:</strong>
                        <span>{{ $banners->double_bedroom }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Single Bedroom:</strong>
                        <span>{{ $banners->single_bedroom }}</span>
                    </li>
                    </ul>
                </div>
                </div>
