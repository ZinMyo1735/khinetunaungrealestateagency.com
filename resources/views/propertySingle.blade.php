...
<section class="intro-single">
    <div class="container">
        ...
        <div class="col-md-12 col-lg-12">
            ...
            <h1 class="title-single">{{ $houses->post_title }}</h1>
            <span class="color-text-a">{{ $houses->location_name }} Township</span>
            </div>
        </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="col-sm-12">
            ...
            <div class="carousel-item-b">
                <img src="{{ asset('storage/'.$houses->image_2) }}" alt="">
            </div>
            <div class="carousel-item-b">
                <img src="{{ asset('storage/'.$houses->image_3) }}" alt="">
            </div>
            <div class="carousel-item-b">
                <img src="{{ asset('storage/'.$houses->image_4) }}" alt="">
            </div>
            </div>
            ...
            <div class="col-md-5 col-lg-4">
                ...
                <div class="card-header-c d-flex">
                    ...
                    <span class="ion-money">{{ $houses->price }}</span>
                    </div>
                ...
                <div class="summary-list">
                    ...
                    <li class="d-flex justify-content-between">
                        ...
                        <span>{{ $houses->location_name }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                    ...
                    <li class="d-flex justify-content-between">
                        <strong>Area:</strong>
                        <span>{{ $houses->dimension }} ft
                        <sup>2</sup>
                        </span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Master Bedroom:</strong>
                        <span>{{ $houses->master_bedroom }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Double Bedroom:</strong>
                        <span>{{ $houses->double_bedroom }}</span>
                    </li>
                    <li class="d-flex justify-content-between">
                        <strong>Single Bedroom:</strong>
                        <span>{{ $houses->single_bedroom }}</span>
                    </li>
                    </ul>
                </div>
                </div>
